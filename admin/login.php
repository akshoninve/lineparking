...
/**
 * admin/login.php
 * Вход в админку (логин/пароль из private/config.php — см. комментарий
 * в includes/admin-auth.php про ADMIN_LOGIN / ADMIN_PASSWORD_HASH).
 */
...
<title>Вход — Админка ЛайнПаркинг</title>
